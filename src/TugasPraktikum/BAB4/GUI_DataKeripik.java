...
public class GUI_DataKeripik extends javax.swing.JFrame {
    ...
    private void hasilbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hasilbuttonActionPerformed
        // TODO add your handling code here:
        // Mengosongkan area teks sebelum menampilkan laporan baru
        datakeripik.setText("");
        
        //Membuat objek keripik untuk menyimpan data dari atribut parent class dan classnya itu sendiri
        Keripik keripik = new Keripik();
        ...
        datakeripik.append("---------------------------------------------------------------------------\n");
        // Menampilkan informasi dasar tentang keripik, menggunakan getter untuk mengambil isi data/nilainya
        datakeripik.append("Nama Snack   : " + keripik.nama_snack + " " + keripik.getVarian() + "\n");
        datakeripik.append("Kategori   : " + keripik.kategori +"\n");
        datakeripik.append("ID Snack   : " + keripik.getID() +"\n");
        datakeripik.append("Harga Satuan   : " + keripik.getHarga() +"\n");
        datakeripik.append("Bahan Baku   : " + keripik.getBahan() +"\n");
        datakeripik.append("Berat Snack   : " + keripik.getBerat() + " gram\n");
        datakeripik.append("Stok   : " + keripik.getStok() +"\n\n");
        
        // Jika checkbox level pedas dipilih, tambahkan info level pedas
        if (cb_level.isSelected()) {
            datakeripik.append("---------------------------------------------------------------------------\n");
            datakeripik.append("Level kepedasan berhasil ditambahkan!\n");
            datakeripik.append("LEVEL PEDAS   : Level " + keripik.LevelPedas() +"\n");
            datakeripik.append("Varian Bumbu   : " + keripik.getVarian() +"\n");
        
        // Jika checkbox penambahan stok dipilih, tambahkan info stok terbaru
            ...
            datakeripik.append("Varian Bumbu   : " + keripik.getVarian() +"\n");
            datakeripik.append("Banyak Penambahan   : " + keripik.getTambah() +"\n");
            datakeripik.append("Stok Terkini   : " + keripik.getTambahstok() + "\n"); 
        
        // Jika tidak ada checkbox yang dipilih, tampilkan info standar
        } else {
            datakeripik.append("---------------------------------------------------------------------------\n");
