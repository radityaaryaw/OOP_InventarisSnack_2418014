...
public class GUI_DataBiskuit extends javax.swing.JFrame {
    ...
    public GUI_DataBiskuit() {
        ...
        txttambah.setText(Integer.toString(biskuit.tambahStok()));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Biskuit biskuit = new Biskuit(); // Pemanggilan class Biskuit
        ...
        biskuit.id_snack = txtid.getText();
        biskuit.harga = Integer.parseInt(txtharga.getText());
        biskuit.stok_snack = Integer.parseInt(txtstok.getText());
        biskuit.jumlah_tambah = Integer.parseInt(txttambah.getText());
        biskuit.kategori = "Biskuit";
        ...
        if (!txtdiskon.getText().isEmpty()) {
            ...
            biskuit.harga = biskuit.setHarga(hargaAsli, diskon); // Simpan hasil perhitungan diskon
        } else {
            biskuit.harga = hargaAsli; //Menampilkan harga aslinya
        }
        // Menambahkan data ke list sesuai data yang diinputkan
        list.add(biskuit.nama_snack);
        list.add(biskuit.id_snack);
        list.add(biskuit.harga);
        ...
        if (cb_tambah.isSelected()) {
            biskuit.tambahStok();
            list.add(biskuit.stok_snack);
            list.add(biskuit.jumlah_tambah);
