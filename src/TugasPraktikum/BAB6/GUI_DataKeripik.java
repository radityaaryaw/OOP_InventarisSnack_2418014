...
public class GUI_DataKeripik extends javax.swing.JFrame {
    ...
    public GUI_DataKeripik() {
        ...
        txttambah.setText(Integer.toString(keripik.tambahStok()));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        list.add(keripik.id_snack);
        list.add(keripik.harga);
        ...
        if (cb_level.isSelected() && cb_tambah.isSelected() ) { //kondisi jika cb_level & cb_tambah dipilih
            ...
            list.add(keripik.tambahStok());
            list.add(keripik.LevelPedas());
            list.add(keripik.jumlah_tambah);
