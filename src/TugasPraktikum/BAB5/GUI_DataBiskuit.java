...
public class GUI_DataBiskuit extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (!txtdiskon.getText().isEmpty()) {
            ...
            biskuit.setHarga(hargaAsli, diskon); // Method overload (hanya di subclass)
        } else {
            biskuit.setHarga(hargaAsli); // Method asli dari parent
        }

        // Menambahkan data ke list sesuai data yang diinputkan
        list.add(biskuit.nama_snack);
        list.add(biskuit.getID());
        list.add(biskuit.getHarga());
        ...
        if (cb_tambah.isSelected()) {
            biskuit.getTambahstok();
            list.add(biskuit.getStok());
            list.add(biskuit.getTambah());
