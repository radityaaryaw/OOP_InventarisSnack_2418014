...
public class GUI_DataKeripik extends javax.swing.JFrame {
    ...
    public GUI_DataKeripik() {
        ...
        Snack snack = new Keripik();
        txtlevel.setText(Integer.toString(((Keripik) snack).level_pedas));
        txtlevel.setEnabled(false); // Menonaktifkan input
        txttambah.setText(Integer.toString(snack.tambahStok())); //memanggil method tambahstok kelas Keripik
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        snack = new Keripik(); //menginisialisasikan objek yang ada pada superclass dengan sub class
        ...
        ((Keripik) snack).level_pedas = Integer.parseInt(txtlevel.getText());
        ((Keripik) snack).setBahan(txtbahan.getText());
        ((Keripik) snack).setVarian(txtbumbu.getText());
        ((Keripik) snack).setBerat(Integer.parseInt(txtberat.getText()));
        ...
        list.add(((Keripik) snack).getBahan());
        list.add(((Keripik) snack).getBerat());
        list.add(((Keripik) snack).getVarian());
        ...
        if (cb_level.isSelected() && cb_tambah.isSelected() ) { //kondisi jika cb_level & cb_tambah dipilih
            ...
            list.add(snack.tambahStok()); //Memanggil method tambahStok() kelas Keripik
            if (snack instanceof Keripik) {
                list.add(((Keripik) snack).level_pedas);
            }
