...
public class GUI_LaporanSnack extends javax.swing.JFrame {
    ...
    public GUI_LaporanSnack() {
        ...
        txttambah.setText(Integer.toString(laporan.jumlah_tambah));
        txtpenjualan.setText(Integer.toString(laporan.jumlah_kurang));
        txttambah.setEnabled(false);
        txtpenjualan.setEnabled(false);
        hasillaporan.setEditable(false); 
    }
    ...
    private void hasilbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hasilbuttonActionPerformed
        ...
        // Mengambil data dari inputan pengguna dan menyimpannya ke atribut objek laporan
        ...
        laporan.jumlah_tambah = Integer.parseInt(txttambah.getText());
        laporan.jumlah_kurang = Integer.parseInt(txtpenjualan.getText());
        ...
        hasillaporan.append("ID Snack   : " + laporan.id_snack +"\n");
        hasillaporan.append("Harga Satuan   : " + laporan.harga +"\n");
        hasillaporan.append("Stok   : " + laporan.stok_snack +"\n");
        
        // Pengecekan apakah checkbox penambahan stok dipilih
        if (cb_tambah.isSelected()){
            hasillaporan.append("---------------------------------------------------------------------------\n");
            hasillaporan.append("Penambahan stok berhasil ditambahkan!\n");
            hasillaporan.append("Nama Snack   : " + laporan.nama_snack + " | " + laporan.id_snack +"\n");
            hasillaporan.append("Harga Satuan   : " + laporan.harga +"\n");
            hasillaporan.append("Banyak Penambahan   : " + laporan.jumlah_tambah +"\n");
            hasillaporan.append("Stok Terkini   : " + laporan.tambahStok()); // Memanggil method tambahStok() untuk menambahkan stok
        ...
        // Pengecekan apakah checkbox penjualan dipilih, jikan kondisi cb_tambah tidak dipilih
            ...
            hasillaporan.append("Nama Snack   : " + laporan.nama_snack + " | " + laporan.id_snack +"\n");
            hasillaporan.append("Harga Satuan   : " + laporan.harga +"\n");
            hasillaporan.append("Produk Terjual   : " + laporan.jumlah_kurang +"\n");
            hasillaporan.append("Stok Terkini   : " + laporan.penjualanProduk()); // Memanggil method penjualanProduk() untuk mengurangi stok
        ...
        // Jika tidak ada checkbox yang dipilih, hanya menampilkan standar laporan
            ...
            hasillaporan.append("Nama Snack   : " + laporan.nama_snack + " | " + laporan.id_snack +"\n");
            hasillaporan.append("Harga Satuan   : " + laporan.harga +"\n");
            hasillaporan.append("Stok Terkini   : " + laporan.stok_snack); // Stok tetap tanpa perubahan
    }  
