...
public class GUI_DataBiskuit extends javax.swing.JFrame {
    ...
    private void hasilbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hasilbuttonActionPerformed
        ...
        biskuit.rasa = txtvarian.getText();
        biskuit.kadaluarsa = txtkadaluarsa.getText();
        biskuit.berat_snack = Integer.parseInt(txtberat.getText());
        
        if(cmb_kemasan.getSelectedIndex()== 0){
            biskuit.kemasan = "Toples";
        }
        else if(cmb_kemasan.getSelectedIndex()== 1){
            biskuit.kemasan = "Kardus";
        }else if(cmb_kemasan.getSelectedIndex()== 2){
            biskuit.kemasan = "Plastik";
        } else {
        ...
        databiskuit.append("---------------------------------------------------------------------------\n");
        databiskuit.append("Nama Snack   : " + laporan.nama_snack +"\n");
        databiskuit.append("Kategori   : " + laporan.kategori +"\n");
        databiskuit.append("ID Snack   : " + laporan.id_snack +"\n");
        databiskuit.append("Harga Satuan   : " + laporan.harga +"\n");
        databiskuit.append("Stok   : " + laporan.stok_snack +"\n\n");
        
        databiskuit.append("Varian Rasa   : " + biskuit.rasa +"\n");
        databiskuit.append("Berat Snack   : " + biskuit.berat_snack + " gram\n");
        databiskuit.append("Masa Kadaluarsa   : " + biskuit.kadaluarsa +"\n");
        databiskuit.append("Kemasan   : " + biskuit.kemasan +"\n");
        databiskuit.append("---------------------------------------------------------------------------\n");
        databiskuit.append("RINCIAN HARGA PER GRAM"+"\n");
        databiskuit.append("Harga " + laporan.nama_snack +" /gram : \n");
        databiskuit.append("Rp. " + biskuit.hargaperGram() +"\n");
        ...
        if (cb_tambah.isSelected()){
            ...
            databiskuit.append("Nama Snack   : " + laporan.nama_snack +"\n");
            databiskuit.append("Varian Rasa   : " + biskuit.rasa +"\n");
            databiskuit.append("Banyak Penambahan   : " + laporan.jumlah_tambah +"\n");
            databiskuit.append("Stok Terkini   : " + laporan.tambahStok()); 
        }
